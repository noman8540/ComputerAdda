...
<body>
  ...
  <div class="container mx-auto">
    <h2 class="text-center py-3 text-primary">Cart Items</h2>
    <div class="row">
      <div class="col">
        <table class="table border">
          ...
          <c:forEach items="${car}" var="pro" varStatus="loop">
            <tr>
              ...
              <!--  
              <c:set var="total" value="${total+pro.products.price }"/>
              -->
              <c:set var="pn" value="${pn}, ${pro.products.name}"/>
              <c:set var="pi" value="${pi},${pro.products.id}"/>
            ...
            <c:set var="allProducts" value="${allProducts}, ${pro.products.name}" />
            <c:set var="totalPrice" value="${totalPrice + pro.products.price}" />
	      ...
	      <div class="col secondcol text-center" >
...
<div class="text-center info">
    <a href="https://wa.me/+917302302355?text=I'm%20interested%20in${allProducts}%20and%20the%20total%20price%20is%20${totalPrice}" target="">
