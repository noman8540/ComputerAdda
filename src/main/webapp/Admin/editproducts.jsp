        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page">Edit Products</li>
                </ol>
            </nav>
        </div>
    </div>
...
<form action="editproducts" method="get" enctype="multipart/form-data" class="mx-auto w-75 abc">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="image_url" class="form-control w-75 mx-3" id="exampleInputEmail1" aria-describedby="emailHelp"value="${pro.image_url}">
  </div>
  
  <div class="mb-3">
    <label for="exampleInputImage" class="form-label mx-3 ab">Short Description</label>
    <input type="text" name="sdesc" class="form-control w-75 mx-3" id="exampleInputEmail1" aria-describedby="emailHelp"value="${pro.sdesc}">
  </div>
  
  
  <div class="mb-3">
    <label for="exampleInputImage" class="form-label mx-3 ab">Long Description</label>
    <input type="text" name="ldesc" class="form-control w-75 mx-3" id="exampleInputImage" aria-describedby="imageHelp" value="${pro.ldesc }">
  </div>
  
  <div class="mb-3">
    <label for="exampleInputPrice" class="form-label mx-3 ab">Price</label>
    <input type="number" name="price" class="form-control w-75 mx-3" id="exampleInputEmail1" aria-describedby="emailHelp"value="${pro.price}">
  </div>
