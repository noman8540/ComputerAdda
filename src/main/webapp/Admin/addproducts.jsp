        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page">Add Products</li>
                </ol>
            </nav>
        </div>
    </div>
...
<form action="additems" method="post" enctype="multipart/form-data" class="mx-auto w-75 abc"style="color:white">
  <div class="mb-3">
    <label for="exampleInputName" class="form-label mx-3 ab" >Name</label>
    <input type="text" name="name" class="form-control w-75 mx-3" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  
  <div class="mb-3">
    <label for="exampleInputImage" class="form-label mx-3 ab">Image</label>
    <input type="file" name="image" class="form-control w-75 mx-3" id="exampleInputImage" aria-describedby="imageHelp">
  </div>
  
  <div class="mb-3">
    <label for="exampleInputImage" class="form-label mx-3 ab">Short Description</label>
    <input type="description" name="sdesc" class="form-control w-75 mx-3" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  
  <div class="mb-3">
    <label for="exampleInputImage" class="form-label mx-3 ab">Long Description</label>
    <input type="description" name="ldesc" class="form-control w-75 mx-3" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  
  <div class="mb-3">
    <label for="exampleInputPrice" class="form-label mx-3 ab">Price</label>
    <input type="number" name="price" class="form-control w-75 mx-3" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  
  <div class="mb-3">
    <label for="exampleInputCategory" class="form-label mx-3 ab">Category</label>
    <select name="category" class="form-control w-75 mx-3">
      <option value="Laptop">P.C Sell</option>     
